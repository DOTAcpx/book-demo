...
public class ScheduledExecutorTest {
    ...
    class LightOff implements Runnable {
        ...
        @Override
        public void run() {
            System.out.println("TurningOff off lights");
            light = false;
        }
    }
    ...
    class CollectData implements Runnable {
        ...
        public void run() {
            ...
            synchronized(ScheduledExecutorTest.this) {
                lastTime.set(Calendar.MINUTE, lastTime.get(Calendar.MINUTE) + 30);
                if(rand.nextInt(5) == 4) tempDirection = -tempDirection;
                lastTemp = lastTemp + tempDirection * rand.nextFloat();
    ...
    public static void main(String[] args) {
        ScheduledExecutorTest gh = new ScheduledExecutorTest();
        ...
        s.scheduleAtFixedRate(()->{
            System.out.println("执行 : " + i[0]);
            i[0] += 1;
            if(i[0] == 50) s.shutdownNow();
